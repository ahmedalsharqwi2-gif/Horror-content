...
⚠️ ملحوظة مهمة: النسخة دي بتتوقع إن الحلقة دايمًا مقسّمة جزئين (زي ما
generate_voice.py الحالي بيضمن دايمًا) — episode["parts"] فيها عنصرين،
كل عنصر فيه "final_audio" و"subtitles" خاصين بيه. هننتج:
- output/final_video_part1.mp4
- output/final_video_part2.mp4

(الاستثناء النادر: لو episode["parts"] فيها عنصر واحد بس — حالة القصة
اللي اتكونت من جملة واحدة بس في generate_voice.py — هننتج output/final_video.mp4
واحد بس.)
...
MAX_DURATION_SECONDS = 90 ثانية — ده الحد الصلب النهائي لكل جزء عشان
يصلح فعليًا لريلز فيسبوك/انستجرام.
"""
